...
exports.run = async(client, message, args) => {
  ...
  let miktarsonuç = (bt.rastgele("500", "pozitif"))
    var sebep = ["Enes Baturu aradı","Enginarı aradı","Orkun Işıtmak'ı aradı","Berkoni' yi aradı", "kimseyi aramadı","Saturn ekibini aradı","zengin birini aradı","kimi arayacağını düşündü","çöpü aradı"]

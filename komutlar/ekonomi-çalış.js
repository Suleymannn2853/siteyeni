...
exports.run = async(client, message, args) => {
  ...
  let miktarsonuç = (bt.rastgele("500", "pozitif"))
    var sebep = ["tadilatçı olarak çalıştı","emlakçı olarak çalıştı","aşçı olarak çalıştı", "enginar satıcısı olarak çalıştı","dilenci olarak çalıştı","enginar olarak çalıştı","Enes batur olarak çalıştı","Saturn olarak çalıştı","su satıcısı olarak çalıştı","boş boş durdu"]

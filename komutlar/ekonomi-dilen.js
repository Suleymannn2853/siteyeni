...
exports.run = async(client, message, args) => {
  ...
  let miktarsonuç = (bt.rastgele("500", "pozitif"))
    var sebep = ["dilendi","Enginardan para dilendi","Saturn'den para dilendi","fadeaway dan para dilendi","kimseden para dilenmedi","şoförden para dilendi","zengin birinden para dilendi","çöpçüden para dilendi"]
